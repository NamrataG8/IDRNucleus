...
const uint16_t IDR_FROM_HSS = 141; 
const uint16_t IMSI_VALIDATION_FAILURE = 142; 
const uint16_t IMSI_VALIDATION_SUCCESS = 143; 
const uint16_t INIT_CTXT_RESP_FROM_UE = 144; 
const uint16_t INTRA_S1HO_START = 145; 
const uint16_t MB_RESP_FROM_SGW = 146; 
const uint16_t MME_INIT_DETACH = 147; 
const uint16_t NAS_PDU_PARSE_FAILURE = 148; 
const uint16_t PAGING_COMPLETE = 149; 
const uint16_t PAGING_FAILURE = 150; 
...
const uint16_t TAU_NOT_REQUIRED = 159; 
const uint16_t TAU_REQUEST_FROM_UE = 160; 
const uint16_t TAU_REQUIRED = 161; 
const uint16_t UE_CTXT_REL_COMP_FROM_ENB = 162; 
const uint16_t ULA_FROM_HSS = 163; 
const uint16_t VALIDATE_IMSI = 164; 
const uint16_t END_EVENT = 165;    
