...
struct fd_dict_objects {
	...
	struct dict_object *IDR; /*Insert-Subscriber-Data-Request*/
	struct dict_object *IDA; /*Insert-Subscriber-Data-Answer*/
...
int
idr_resp_callback(struct msg **msg, struct avp *avp, struct session *sess,
		void *data, enum disp_action *act);
